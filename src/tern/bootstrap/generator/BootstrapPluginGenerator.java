...
public class BootstrapPluginGenerator implements tern.bootstrap.generator.IGenerator
 {
  protected static String nl;
  public static synchronized BootstrapPluginGenerator create(String lineSeparator)
  {
    nl = lineSeparator;
    BootstrapPluginGenerator result = new BootstrapPluginGenerator();
    nl = null;
    return result;
  }
